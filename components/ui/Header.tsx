// Phase banner lives inside this component so every screen gets it
// automatically. Adding it per-screen would be easy to forget.
        ...
        <div className="govuk-phase-banner">
          <p className="govuk-phase-banner__content">
            ...
            <span className="govuk-phase-banner__text">
              ...
              are the authoritative source — always verify with a tax adviser.
            </span>
          </p>
        </div>
      </div>
